    ...
    <QueryClientProvider client={queryClient}>
      <BrowserRouter>
        ...
        <MoviesContextProvider>
          <AuthContextProvider>
            <Routes>
              <Route path="/movies/favorites" element={<PrivateRoutes><FavoriteMoviesPage /></PrivateRoutes>}/>
              ...
              <Route path="/page=:pageNumber/toprated" element={<TopRatedMoviesPage />} />
              <Route path="/page=:pageNumber/upcoming" element={<UpcomingMovies />} />
